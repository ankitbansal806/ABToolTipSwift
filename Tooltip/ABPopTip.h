...
/**-----------------------------------------------------------------------------
 * @name ABPopTip Options
 * -----------------------------------------------------------------------------
 */

/** @enum ABPopTipDirection
 *
 * Enum that specifies the direction of the poptip.
 */
typedef NS_ENUM(NSInteger, ABPopTipDirection) {
    /** Shows the poptip up */
    ABPopTipDirectionUp,
    /** Shows the poptip down */
    ABPopTipDirectionDown,
    /** Shows the poptip to the left */
    ABPopTipDirectionLeft,
    /** Shows the poptip to the right */
    ABPopTipDirectionRight,
    /** Shows the poptip up, with no arrow */
    ABPopTipDirectionNone
};

/** @enum ABPopTipEntranceAnimation
 *
 * Enum that specifies the type of entrance animation. Entrance animations are performed
 * while showing the poptip.
 */
typedef NS_ENUM(NSInteger, ABPopTipEntranceAnimation) {
    /** The poptip scales from 0% to 100% */
    ABPopTipEntranceAnimationScale,
    /** The poptip moves in position from the edge of the screen */
    ABPopTipEntranceAnimationTransition,
    /** No animation */
    ABPopTipEntranceAnimationNone,
    /** The Animation is provided by the user */
    ABPopTipEntranceAnimationCustom
};

/** @enum ABPopTipActionAnimation
 *
 ...
 */
typedef NS_ENUM(NSInteger, ABPopTipActionAnimation) {
 ...
 */
@property (nonatomic, assign) ABPopTipEntranceAnimation entranceAnimation UI_APPEARANCE_SELECTOR;

/** Action animation type
 *
 * Holds the enum with the type of action animation (triggered once the popover is shown)
 */
@property (nonatomic, assign) ABPopTipActionAnimation actionAnimation UI_APPEARANCE_SELECTOR;
 ...
 * when using a ABPopTipActionAnimationCustom entrance animation type.
 ...
 */
@property (nonatomic, assign, readonly) ABPopTipDirection direction;
